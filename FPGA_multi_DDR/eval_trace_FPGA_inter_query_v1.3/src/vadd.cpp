...
#if N_CHANNEL >= 2
	float* debug_out_per_query_dists_chan_1,
#endif
#if N_CHANNEL >= 3
	float* debug_out_per_query_dists_chan_2,
#endif
#if N_CHANNEL >= 4
	float* debug_out_per_query_dists_chan_3,
#endif


	int* debug_out_per_query_ids_chan_0,
#if N_CHANNEL >= 2
	int* debug_out_per_query_ids_chan_1,
#endif
#if N_CHANNEL >= 3
	int* debug_out_per_query_ids_chan_2,
#endif
#if N_CHANNEL >= 4
	int* debug_out_per_query_ids_chan_3,
#endif
