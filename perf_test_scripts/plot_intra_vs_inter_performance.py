...
Example usage:
    ...
    python plot_intra_vs_inter_performance.py --df_path_intra_query ./saved_df/latency_FPGA_intra_query_4_chan.pickle --df_path_inter_query ./saved_df/latency_FPGA_inter_query_4_chan.pickle
"""
