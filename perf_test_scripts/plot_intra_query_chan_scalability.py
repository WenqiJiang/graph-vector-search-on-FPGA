...
Example usage:
    ...
    python plot_intra_query_chan_scalability.py --df_path_1_chan ./saved_df/latency_FPGA_intra_query_1_chan.pickle --df_path_2_chan ./saved_df/latency_FPGA_intra_query_2_chan.pickle --df_path_4_chan ./saved_df/latency_FPGA_intra_query_4_chan.pickle
"""
