...
def plot_subgraph(dataset='SIFT1M', max_degree=64, comparison_recall=0.99,
                 min_recall=0.95, max_recall=0.995, min_node_counter=0, max_node_counter=20000):
    ...
    plt.savefig(f'./images/subgraph_vs_full_graph/subgraph_vs_full_graph_{dataset}.png', transparent=False, dpi=200, bbox_inches="tight")
