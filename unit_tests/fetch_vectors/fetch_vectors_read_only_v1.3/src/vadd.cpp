...
#pragma HLS INTERFACE m_axi port=db_vectors latency=1 num_read_outstanding=64 num_write_outstanding=1 offset=slave bundle=gmem1 // share the same AXI interface with query_vectors
